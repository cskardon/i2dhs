...
df_local_authority_change |> 
    ...
    coord_flip() +
     labs(
        title = "Difference between 2014 and 2023 in the percent of the population prescribed drugs for anxiety, depression and psychosis by local authority in Scotland",
...
df_local_authority_change = (df_local_authority_change)
```
