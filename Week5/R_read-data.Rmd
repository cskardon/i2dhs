...
# echo outputs the 'text' of the code - i.e. you're echoing the commands, not just the output 
```
...
```{r}
psa <- read.table(here('data/psa.txt'))
psa
```


```{r 'The readr way'}
psa <- read_table(here('data/psa.txt'))
psa
```
...
```{r}
fev_data_2 <- read_csv(here("data/fev.csv"), col_names = FALSE, skip=10, n_max=10)
fev_data_2
```

```{r}
# fev_header <- read_csv(here("data/fev.csv"), col_names = FALSE, n_max=1, show_col_types = FALSE)
# fev_header
#fev_header
# fev_data <- read_csv(here("data/fev.csv"), col_names = FALSE, skip=10, n_max=10)
#fev_data
# fev_combine <- read_csv(here("data/fev.csv"), col_names = FALSE, skip=10, n_max=10, col_names = fev_header[0])
# fev_combine
```
